...
image:composeApp/src/commonMain/composeResources/drawable/flag_bg.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_cn.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_cz.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_de.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_dk.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_en.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_es.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_fi.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_fr.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_gr.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_hr.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_hu.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_ir.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_it.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_jp.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_nl.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_no.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_pl.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_pt.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_ro.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_ru.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_rs.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_se.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_sk.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_sl.png[]
image:composeApp/src/commonMain/composeResources/drawable/flag_tr.png[]
...
So click on the little gear icon on the left panel, and you will see the following form where you have
...
There is one caveat with this: If you decide to edit the project afterward and modify the package textured dir so that it points to a project using a different texture format than before, the format will not be updated.
The finished configuration will look something like this:

image::resources/screen-10.png[]

When you click "OK" you should see something like this - your first project configuration:
If you have only one airplane the group is automatically expanded.
When you work on more projects all groups are collapsed when the app is started.
Just click on the group header to expand it or collapse it again.
...
image::resources/screen-16.png[]

When you click ion the info button on the left panel you will see the current version and some useful links.

image::resources/screen-17.png[]
