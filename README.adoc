...
WARNING: For now there are no safeguards. The project is in early alpha state but can already be used.
...
Zhis document in form of a PDF file can be found link:docs/README.pdf[here]
