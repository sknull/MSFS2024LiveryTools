package de.visualdigits.msfs2024tools.domain.util
...
inline fun <reified T> T.writeValueAsJsonString(): String {
    val mapper = Json {
        explicitNulls = false
...
inline fun <reified T> T.writeValueAsJsonFile(file: File) {
    file.writeText(writeValueAsJsonString())
}
